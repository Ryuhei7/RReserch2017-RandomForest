...
# ADASYNを施す
adasyn = ADASYN(ratio={1.0:int(positive_count_train[3.0]), 2.0:int(positive_count_train[3.0]), 3.0:int(positive_count_train[3.0])}, random_state=0)

# ADASYNを学習データに反映
train_data_resampled, train_label_resampled = adasyn.fit_sample(train_data, train_label)
